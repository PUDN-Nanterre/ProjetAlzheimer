...
-   En 2012, pic de publications globales. Cinq ans plus tard, en 2017, on observe un pic dans le nombre de publications dédiées à la maladie d'Alzheimer dans le domaine des SHS.
...
Nous avons trié, dans l’ordre croissant, les 20 revues les plus actives sur le sujet de l’Alzheimer.
...
Puis, nous avons associé à chaque revue un domaine principal en cherchant via le moteur de recherche HAL, dans quels domaines la revue publiait le plus.
...
Créer une autre colonne pour calculer le nombre d'auteurs de chaque publication.
...
Extraire la valeur correspondante à la position de la colonne ordre dans la colonne 'AutList' de chaque ligne et l'assigner à la colonne 'Auteur'.

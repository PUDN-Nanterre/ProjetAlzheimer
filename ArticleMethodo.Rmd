...
Un mot ajouté après '_' (souligne) signifie le type de chaque colonne.  
- '_i' : interger (entier)  
...
Afin de rendre les modalités plus explicites, par exemple, pour le type et la langue du document, nous utilisons la fonction `var_label` pour attribuer des libellés descriptifs aux niveaux des variables catégorielles.

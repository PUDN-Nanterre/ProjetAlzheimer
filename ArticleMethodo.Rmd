...
### **2. Librairies de nettoyage de données**
...
### **3. Librairie de statistiques descriptives rapides**
...
### **4. Librairies de manipulation et visualisation des données**
...
### **5. Librairie de prétraitement du texte**
...
# Extraction des données à partir de l'API
...
Avant de donner des étiquettes aux domaines, nous allons d'abord agréger les données liées à ces derniers, pour les catégoriser et les assembler pertinemment.

#### **a) Agrégation des données liées aux domaines**

Nous allons créé une variable `domaine_gpe`pour les regrouper les domaines.
...
### Étape 2 : Préparation du dataset de revues

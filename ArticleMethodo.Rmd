...
nuage_corpus_clean<-tm_map(nuage_corpus_clean,removeWords,stopwords("english")) nuage_corpus_clean<-tm_map(nuage_corpus_clean,removeWords,stopwords("fr")) nuage_corpus_clean<-tm_map(nuage_corpus_clean,removeWords,"alzheimer") 
